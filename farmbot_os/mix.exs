defmodule FarmbotOS.MixProject do
  ...
  defp deps do
    [
      ...
      tag: "v1.15.1-farmbot.1", runtime: false, targets: :rpi4},
      {:farmbot_telemetry, path: "../farmbot_telemetry", env: Mix.env()},
      {:luerl, github: "rvirding/luerl"},
      {:mdns_lite, "~> 0.6.7", targets: @all_targets},
      ...
      {:rollbax, ">= 0.0.0"},
      {:shoehorn, "~> 0.7"},
      {:toolshed, "~> 0.2.19", targets: @all_targets},
      {:vintage_net_ethernet, "~> 0.10.0", targets: @all_targets},
